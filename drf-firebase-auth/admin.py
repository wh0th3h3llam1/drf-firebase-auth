...
class FirebaseUserAdmin(BaseUserAdmin):
    ...
    def save_model(self, request, obj, form, change):
        if not obj.id:
            ...
            """
            To update an existing user in firebase, to add/change phone_number and(or) email
            ...
            try:
                ...
                if "phone_number" in form.changed_data:
                    data.update(
                        {
                            "phone_number": f"+{obj.phone_number.country_code}{obj.phine_number.national_number}"
                        }
                    )
