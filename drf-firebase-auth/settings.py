...
# Firebase
FIREBASE_CONFIG.setdefault(
	"FIREBASE_SERVICE_ACCOUNT", settings.FIREBASE_CONFIG["FIREBASE_SERVICE_ACCOUNT"]
)
FIREBASE_CONFIG.setdefault(
	"FIREBASE_WEBAPP_CONFIG", settings.FIREBASE_CONFIG["FIREBASE_WEBAPP_CONFIG"]
)
